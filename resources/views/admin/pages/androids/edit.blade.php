...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} android
    </div>

    <div class="card-body">
        <form action="{{ route("admin.androids.update", [$androids->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
           <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label for="calling_plane_costing_id">Calling Plan*</label>
