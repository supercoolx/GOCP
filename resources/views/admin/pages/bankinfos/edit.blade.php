...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} bankinfo
    </div>

    <div class="card-body">
        <form action="{{ route("admin.bankinfos.update", [$bankinfos->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
           <div class="row">
            <div class="col-md-4">
          ...
          <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" id="bank_email" name="bank_email" class="form-control" value="{{ old('bank_email', isset($bankinfos) ? $bankinfos->bank_email : '') }}" required>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" id="bank_account_email" name="bank_account_email" class="form-control" value="{{ old('bank_account_email', isset($bankinfos) ? $bankinfos->bank_account_email : '') }}" required>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
...
@section('scripts')
    <script type="text/javascript">
        $("#category").val("{{ $bankinfos->category }}");
        $("#status").val("{{ $bankinfos->status }}");
