           ...
           <div class="row">
             <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="time_range" name="time_range" class="form-control" value="{{ old('time_range', isset($carrierinvoices) ? $carrierinvoices->time_range : '') }}" required>
                </div>
            </div>
             ...
             <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" id="total_mints" name="total_mints" class="form-control" value="{{ old('total_mints', isset($carrierinvoices) ? $carrierinvoices->time_range : '') }}" required>
                </div>
            </div>
...
@section('scripts')
    <script type="text/javascript">
        $("#category").val("{{ $carrierinvoices->category }}");
        $("#carrier_buy_rout_id").val("{{ $carrierinvoices->carrier_buy_rout_id }}");
        $("#status").val("{{ $carrierinvoices->status }}");
